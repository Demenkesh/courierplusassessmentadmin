...
(function($) {
    ...
    $(window).on('load', function() {
        HunThemesMainJS.videoDivToView()
    ...
    var HunThemesMainJS = {
        ...
        /**
         * Bring video div to view
         *
         */
        videoDivToView:function (){
            var $videoDiv = document.getElementById('kokoafone_video');
            var link = "https://kokoafone.com/#kokoafone_video"
            //var link = "http://localhost:63342/kokoafone/index.html#kokoafone_video"

            if( window.location.href === link){
                window.scroll(0, findPosition($videoDiv));
            }
